    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div class="bg-gray-800 rounded-lg shadow-lg p-6">
            <div class="flex items-center">
                <div class="p-3 rounded-full bg-cyan-500 text-white mr-4 w-11 h-11 flex items-center justify-center">
                    <i class="bi bi-window-stack"></i>
                </div>
                <div>
                    <p class="text-gray-400">Total Sites</p>
                    <h3 class="text-3xl font-bold">{{ $sitesCount }} / {{ $sitesLimit }}</h3>
                </div>
            </div>
            <a
                href="{{ route('sites.index') }}"
                class="mt-4 inline-block text-cyan-400 hover:text-cyan-300"
            >
        ...
        <div class="bg-gray-800 rounded-lg shadow-lg p-6">
            <div class="flex items-center">
                <div class="p-3 rounded-full bg-blue-500 text-white mr-4 w-11 h-11 flex items-center justify-center">
    ...
    <div class="mt-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <a
                ...
                class="block p-5 bg-gray-800 rounded-lg shadow-lg hover:bg-gray-700 transition duration-200 text-center"
            >
