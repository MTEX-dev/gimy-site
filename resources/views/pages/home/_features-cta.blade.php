<div class="py-24 sm:py-32">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        >
            <div class="px-6 lg:px-0 lg:pr-4 lg:pt-4 fade-in-up">
                    ...
                    >
                        <div class="relative pl-9">
                            <dt class="inline font-semibold text-white">
                                <i
                                    class="bi bi-files absolute left-1 top-1 text-indigo-400"
                                ></i>
                                Multi-Page Architecture.
                            </dt>
                            <dd class="inline">
                                Structure your project with multiple pages,
                        ...
                        <div class="relative pl-9">
                            <dt class="inline font-semibold text-white">
                                <i
                                    class="bi bi-lightning-charge-fill absolute left-1 top-1 text-indigo-400"
                                ></i>
                                Instant Deployment.
                            </dt>
                            <dd class="inline">
                                Go live with a single click to a clean
                                `your-site.gimy.site` subdomain.
                            </dd>
                        </div>
                    </dl>
                </div>
            </div>
            <div class="sm:px-6 lg:px-0 zoom-in" style="--delay: 200ms">
                <div
                    class="relative isolate overflow-hidden bg-indigo-500 px-6 pt-8 shadow-2xl sm:rounded-3xl sm:px-16 md:pt-16 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0"
                >
                    <div
                    ...
                    >
                        ...
                        <p class="mt-6 text-lg leading-8 text-indigo-100">
                            Start your next project on gimy.site and see how
                            fast you can bring your ideas to life.
                        </p>
                        <div
                        ...
                        >
                            <a
                                href="{{ route('register') }}"
                                class="rounded-md bg-white px-3.5 py-2.5 text-sm font-semibold text-indigo-600 shadow-sm hover:bg-indigo-50"
                                >Get started</a
                            >
                        </div>
                    </div>
