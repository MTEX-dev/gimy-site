  ...
  <body>
    <div class="container">
      ...
      <p class="footer-text">
        ...
        <a href="' .
                    route('sites.explorer', ['site' => $site->id]) .
                    '">File Explorer</a> |
        <a href="' .
                    route('sites.files.create', ['site' => $site->id]) .
                    '">Add Files</a>
      </p>
    </div>
...
',
        ...
        foreach ($files as $fileData) {
            ...
            $siteFile->path = $fileData['path'];
            $siteFile->content = $fileData['content'];
            $siteFile->save();

            Storage::disk('sites')->put(
                $site->id . '/' . $siteFile->path,
                $siteFile->content,
            );
        }
